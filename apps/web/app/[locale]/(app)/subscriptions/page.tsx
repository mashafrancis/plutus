...
import SubscriptionSummary from '@/app/[locale]/(app)/subscriptions/_components/summary'
import SubscriptionTable from '@/app/[locale]/(app)/subscriptions/_components/table'
