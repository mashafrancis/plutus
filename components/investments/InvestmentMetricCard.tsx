...
export function InvestmentMetricCard({
  ...
  const formatCurrencyValue = (val: number) =>
    formatCurrency({ value: val, currency, locale });
  ...
  if (performer) {
    ...
    displaySubtext = `${performer.ticker} • ${formatCurrencyValue(performer.gainLossDollar)}`;
    ...
    displayValue = formatCurrencyValue(gainLoss.dollar);
    ...
    displayValue = formatCurrencyValue(todayChange.dollar);
