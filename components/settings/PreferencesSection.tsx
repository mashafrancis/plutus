...
import type { InsightType, Preferences } from "@/lib/types/settings";
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            <div className="space-y-2">
              ...
              <Select
                onValueChange={(value) =>
                  onUpdate?.({ theme: value as Preferences["theme"] })
                }
            ...
            <div className="space-y-2">
              ...
              <Select
                onValueChange={(value) =>
                  onUpdate?.({ currency: value as Preferences["currency"] })
                }
            ...
            <div className="space-y-2">
              ...
              <Select
                onValueChange={(value) =>
                  onUpdate?.({
                    dateFormat: value as Preferences["dateFormat"],
                  })
                }
