...
import type { IncomeFilters, FilterOptions, RecurringFilter } from '../types'
    ...
    <div className="space-y-4">
      ...
      <div className={cn(
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="outline" className="font-geist-sans">
              {selectedSource || 'Source'} <ChevronDown className="ml-2 h-4 w-4" />
            </Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent align="start" className="w-56">
      ...
      {(selectedSource || selectedAccount || selectedTags.length > 0 || selectedRecurring) && (
